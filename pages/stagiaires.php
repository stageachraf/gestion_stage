<?php
   ...
   if($idfiliere==0){
          $requeteStagiaire="select idStagiaire,nom,prenom,nomFiliere,photo,civilite from filiere as f,stagiaire as s 
        ...
        $requeteStagiaire="select idStagiaire,nom,prenom,nomFiliere,photo,civilite from filiere as f,stagiaire as s 
         ...
         and f.idFiliere=$idfiliere
          ...
          $requeteCount="select count(*) countS from stagiaire where (nom like 
          '%$nomPrenom%' or prenom like '%$nomPrenom%' )
          ...
          <div class="panel panel-success margetop60">
            ...
            <div class="panel-body">
                <form method="get" action="stagiaires.php" class="form-inline">
                   ...
                   <label for="idfiliere">Niveau:</label>  
            ...
            <div class="panel-body">
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>Id Stagiaire </th><th>Nom</th><th>Prénom</th><th>filière</th><th>Photo</th>
                             <?php if($_SESSION['user']['role']=='ADMIN'){ ?>
                                <th>Actions</th>
                        </tr>
                        <?php } ?>
                         ...
                         <?php while($stagiaire=$resultatStagiaire->fetch()){ ?>
                            <tr> 
                                ...
                                <td>
                                    ...
                                    &nbsp;
                                    <a onclick="return confirm('etes vous sure de vouloire supprimer la Stagiaire')"
